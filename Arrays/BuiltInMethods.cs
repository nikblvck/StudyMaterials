...
namespace BuiltInMethods
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine($"The first song that has more than 10 characters is {findName}.");

      Array.Sort(summerStrut);
      string firstSong = summerStrut[0];
      string lastSong = summerStrut[summerStrut.Length - 1];
      Console.WriteLine($"The first song in the playlist is {firstSong}.");
      Console.WriteLine($"The last song in the playlist is {lastSong}.");
    }
  }
}
